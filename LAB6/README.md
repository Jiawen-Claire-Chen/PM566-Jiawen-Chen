...
\# Q2 Tokenize the the words in the transcription column Count the
...
![](README_files/figure-gfm/token-transciption-1.png)<!-- --> A lot of
stopwards here
...
![](README_files/figure-gfm/trigrams-transcription-1.png)<!-- --> Top 20
trigrams seemed to return a few more medical with

\#5. Using the results you got from questions 4. Pick a word and count
the words that appears after and before it.
